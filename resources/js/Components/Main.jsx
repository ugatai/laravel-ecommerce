export default function Main() {
    return (
        <main className="bg-gradient-to-r from-stone-100 to-white py-5">
                ...
                >
                    <div className="bg-gray-900 bg-opacity-50 flex items-center h-full">
                        <div className="px-10 max-w-xl">
                            ...
                            <p className="mt-2 text-gray-400">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            ...
                            <button
                                ...
                                <span>Shop Now</span>
                                <svg className="h-5 w-5 mx-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
